RubyLLM.configure do |config|
  if ENV["GITHUB_TOKEN"].present?
    ...
    config.openai_api_base = ENV.fetch("GITHUB_MODELS_API_BASE", "https://models.github.ai/inference")
    config.default_model = ENV.fetch("GITHUB_MODELS_MODEL", "openai/gpt-4o")
